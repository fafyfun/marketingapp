...
<a class="btn btn-danger" onclick="deleteAcc('<?php echo base_url() ?>google/revokeToken','') ">Remove Google Account</a>
<?php } ?>
                    ...
                    <?php } else {
                        foreach ($selectProfile as $item) {
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <a href="<?php echo base_url() ?>google/details/<?php echo $item->web_id ?>"><i
                                            class="fa fa-search text-navy"></i></a>
                                    <a onclick="deleteAcc('<?php echo base_url() ?>google/deleteAcc/<?php echo $item->web_id ?>','') "><i
